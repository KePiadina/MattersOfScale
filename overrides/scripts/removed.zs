/*
 * These items are completely disabled for various reasons, from not fitting into the modpack theme, skipping progression, or other reasons that will be listed in the comments
 */

//Death Urn - Gravestones are already present
mods.jei.JEI.removeAndHide(<enderio:block_death_pouch>);
mods.jei.JEI.removeAndHide(<enderio:item_material:81>);

//AE2 Presses and Inscribers - Not required, meteorites don't spawn either so they would be unobtainable
...
//Neutronium is obtained from NC Neutron fluid
...
//Tinker Alloying - Breaks progression, makes the smeltery too broken, and removing them helps players use it as a mass smelter
...
//Uncrafting grinder - Overpowered, breaks recipes
mods.jei.JEI.removeAndHide(<cyclicmagic:uncrafting_block>);

//Corrupted Chorus - Overpowered, breaks gameplay balance
mods.jei.JEI.removeAndHide(<cyclicmagic:corrupted_chorus>);

//Ex Nihilo End Cake - Dimensional Edibles is already present
mods.jei.JEI.removeAndHide(<exnihilocreatio:block_end_cake>);

//Avaritia & Extended Crafting gear - Red herring + Powersuit is supposed to be the endgame armor 
